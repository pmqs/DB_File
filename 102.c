/*
 * This file was generated automatically by xsubpp version 1.924 from the 
...
/* 
 ...
 last modified 26th November 1995
 version 1.02
...
XS(XS_DB_File_db_TIEHASH)
{
    ...
    dXSI32;
    if (items < 1 || items > 5)
       croak("Usage: %s(dbtype, name=undef, flags=O_RDWR, mode=0640, type=DB_HASH)", GvNAME(CvGV(cv)));
    {
...
XS(boot_DB_File)
{
...

    {
        ...
        newXSproto("DB_File::constant", XS_DB_File_constant, file, "$$");
        ...
        XSANY.any_i32 = 0 ;
        sv_setpv(cv, "$;$$$$") ;
        newXSproto("DB_File::DESTROY", XS_DB_File_db_DESTROY, file, "$");
        newXSproto("DB_File::DELETE", XS_DB_File_db_DELETE, file, "$$;$");
        newXSproto("DB_File::FETCH", XS_DB_File_db_FETCH, file, "$$;$");
        newXSproto("DB_File::STORE", XS_DB_File_db_STORE, file, "$$$;$");
        newXSproto("DB_File::FIRSTKEY", XS_DB_File_db_FIRSTKEY, file, "$");
        newXSproto("DB_File::NEXTKEY", XS_DB_File_db_NEXTKEY, file, "$$");
        newXSproto("DB_File::unshift", XS_DB_File_unshift, file, "$;@");
        newXSproto("DB_File::pop", XS_DB_File_pop, file, "$");
        newXSproto("DB_File::shift", XS_DB_File_shift, file, "$");
        newXSproto("DB_File::push", XS_DB_File_push, file, "$;@");
        newXSproto("DB_File::length", XS_DB_File_length, file, "$");
        newXSproto("DB_File::del", XS_DB_File_db_del, file, "$$;$");
        newXSproto("DB_File::get", XS_DB_File_db_get, file, "$$$;$");
        newXSproto("DB_File::put", XS_DB_File_db_put, file, "$$$;$");
        newXSproto("DB_File::fd", XS_DB_File_db_fd, file, "$");
        newXSproto("DB_File::sync", XS_DB_File_db_sync, file, "$;$");
        newXSproto("DB_File::seq", XS_DB_File_db_seq, file, "$$$$");
    }
    ST(0) = &sv_yes;
    XSRETURN(1);
}
