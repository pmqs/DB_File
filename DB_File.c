/*
 * This file was generated automatically by xsubpp version 1.938 from the 
...
XS(XS_DB_File_db_DoTie_)
{
    dXSARGS;
    if (items < 1 || items > 5)
	croak("Usage: DB_File::DoTie_(dbtype, name=undef, flags=O_CREAT|O_RDWR, mode=0640, type=DB_HASH)");
    {
...
XS(boot_DB_File)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("DB_File::DoTie_", XS_DB_File_db_DoTie_, file);
